        ...
        >
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-10">
              ...
              <ul className="list-disc list-inside text-white/55 space-y-2 leading-relaxed">
            ...
            <section className="mb-10">
              ...
              <p className="text-white/55 leading-relaxed">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 text-[#007AFF] hover:text-[#60B4FF] transition-colors"
                >
