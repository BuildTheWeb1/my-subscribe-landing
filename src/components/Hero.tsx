...
export default function Hero() {
  return (
    <section
      ...
      className="pt-28 pb-16 md:pt-32 md:pb-20 px-6 overflow-hidden"
      style={{
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            {/* Eyebrow tag */}
            <div className="inline-flex items-center gap-2 bg-[rgba(0,122,255,0.12)] border border-[rgba(0,122,255,0.2)] rounded-full px-4 py-1.5 mb-4 md:mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-[#007AFF] shadow-[0_0_4px_rgba(0,122,255,0.55)]" />
              <span className="text-xs font-semibold text-[#60B4FF]">iOS App · Free Download</span>
            </div>

            <h1
              id="hero-heading"
              className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight tracking-tight mb-4 md:mb-6"
            >
              See What Your
            ...
            <p className="text-base text-white/50 mb-5 md:mb-6 max-w-lg leading-relaxed">
              No accounts. No spreadsheets. Just a clear view of where your money goes.
            </p>

            {/* Glass social proof card */}
            <div className="bg-white/[0.04] border border-white/[0.08] rounded-xl backdrop-blur-sm p-3 md:p-4 mb-6 md:mb-8 max-w-sm">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="hidden sm:inline-flex bg-white/[0.06] border border-white/10 text-white/50 text-xs font-semibold px-3 py-1 rounded-full">
                  📱 On-Device
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 items-start sm:items-center">
              ...
              <motion.a
                href="#features"
                className="text-sm text-white/55 underline underline-offset-4 decoration-white/20 hover:text-white/70 transition-colors"
              >
                See how it works ↓
              </motion.a>
            </div>
