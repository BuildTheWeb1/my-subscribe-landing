...
export const softwareApplicationSchema = {
  ...
  url: "https://my-subscribe.app",
  downloadUrl: "https://apps.apple.com/app/my-subscribe/id6757849924",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "USD",
  ...
  featureList: [
    ...
    "See monthly and yearly costs at a glance",
    "Paid-so-far total per subscription since signup",
    "Renewal calendar with 30-day upcoming renewals view",
    "Home Screen widgets (small, medium, large)",
    "Multi-currency display with live exchange rates",
    "Curated service catalog for quick subscription setup",
    "Category-based spending breakdown with charts",
    "Biometric lock (Face ID / Touch ID / Optic ID)",
